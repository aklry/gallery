...
/** 获取生成图片的任务 POST /api/v1/picture/ai/generate/image_task */
export async function pictureControllerGetGenerateImageTaskV1(
    body: {
        text?: string
    },
    options?: { [key: string]: any }
) {
    return ryRequest.request<API.AiGenerateImageCreateTaskVo>('/api/v1/picture/ai/generate/image_task', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
        },
...
/** 生成图片 GET /api/v1/picture/ai/generate/image/${param0} */
export async function pictureControllerGenerateImageV1(
    // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
    params: API.PictureControllerGenerateImageV1Params,
    options?: { [key: string]: any }
) {
    const { taskId: param0, ...queryParams } = params
    return ryRequest.request<API.AiGenerateImageSuccessVo>(`/api/v1/picture/ai/generate/image/${param0}`, {
        method: 'GET',
        params: { ...queryParams },
        ...(options || {})
    })
