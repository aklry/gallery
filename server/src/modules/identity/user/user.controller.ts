...
import { AuthGuard, RoleGuard } from '@identity/auth/auth.guard'
import { User } from './entities/user.entity'
import { Roles } from '@identity/role/role.decorator'
import { UserRole } from './enum/user'
import { DeleteRequest } from '@shared/common/delete.dto'
import { FileInterceptor } from '@nestjs/platform-express'
import { UploadAvatarVo } from './vo/upload-avatar.vo'
import { PermissionKit } from '@identity/permission/permission.guard'
@Controller({
    path: 'user',
    version
})
